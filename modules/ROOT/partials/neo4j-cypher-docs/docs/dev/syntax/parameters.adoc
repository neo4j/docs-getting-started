...
include::includes/exampleWithStringLiteralAsParameter.adoc[]

You can use parameters in this syntax as well:

include::includes/exampleWithShortSyntaxStringLiteralAsParameter.adoc[]


[[cypher-parameters-regular-expression]]
== Regular expression

include::includes/exampleWithParameterRegularExpression.adoc[]


[[cypher-parameters-case-sensitive-pattern-matching]]
== Case-sensitive string pattern matching

include::includes/exampleWithParameterCSCIStringPatternMatching.adoc[]


[[cypher-parameters-create-node-with-properties]]
== Create node with properties

include::includes/create_node_from_map.adoc[]


[[cypher-parameters-create-multiple-nodes-with-properties]]
== Create multiple nodes with properties

include::includes/create_multiple_nodes_from_map.adoc[]
...
include::includes/set_properties_on_a_node_from_a_map.adoc[]


[[cypher-parameters-skip-and-limit]]
== `SKIP` and `LIMIT`

include::includes/exampleWithParameterForSkipLimit.adoc[]


[[cypher-parameters-node-id]]
== Node id

include::includes/exampleWithParameterForNodeId.adoc[]


[[cypher-parameters-multiple-node-ids]]
== Multiple node ids

include::includes/exampleWithParameterForMultipleNodeIds.adoc[]


[[cypher-parameters-call-procedure]]
== Calling procedures

include::includes/exampleWithParameterProcedureCall.adoc[]
