[[query-plan-relationship-index-seek]]
...
.Query
include::includes/query-plan-relationship-index-seek.query.adoc[]
...
| |                                +-----------------------------------------------------------------------+----------------+------+---------+----------------+                        |           +---------------------+
| +UndirectedRelationshipIndexSeek | (candidate)-[r:WORKS_IN(title)]-(anon_31) WHERE title = $autostring_0 |              4 |    2 |       3 |             72 |                    3/1 |     0.513 | Fused in Pipeline 0 |
+----------------------------------+-----------------------------------------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
