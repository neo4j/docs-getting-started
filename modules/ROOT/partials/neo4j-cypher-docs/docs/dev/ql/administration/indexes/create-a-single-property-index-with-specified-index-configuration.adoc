...
.Query
include::includes/administration-indexes-create-a-single-property-index-with-specified-index-configuration.query.adoc[]


Can be combined with specifying index provider.

.Result
include::includes/administration-indexes-create-a-single-property-index-with-specified-index-configuration.result.adoc[]

.Try this query live
include::includes/administration-indexes-create-a-single-property-index-with-specified-index-configuration.console.adoc[]
