...
Available both as a standalone tool and as a service in Aura.
...
Refer to link:https://neo4j.com/docs/data-importer/current/[Neo4j Data Importer] documentation for a complete guide.
