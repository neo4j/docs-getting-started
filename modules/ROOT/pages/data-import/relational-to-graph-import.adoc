...
Apache Hop, an abbreviation for Hop Orchestration Platform, serves as a data orchestration and data engineering platform, designed to facillitate all aspects of data flows creation and management. 

The source code from the link:https://github.com/mattcasters/hop-neo4j[Neo4j Apache Hop^] project has been integrated into Apache Hop framework.
If you download a recent version, you get the most recent version of the Neo4j plugins as well.

Using Apache Hop, you can load large datasets in Neo4j, update graphs, and get logging information.
...
* Blog post: link:https://www.know-bi.be/blog/5-minutes-to-write-to-neo4j-with-apache-hop[5 minutes to load data to Neo4j and other graph databases with Apache Hop^]
