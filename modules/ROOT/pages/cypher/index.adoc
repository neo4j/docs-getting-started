...
Now that the basic Cypher concepts have been introduced, you can take the tutorial on how to xref:cypher/intro-tutorial.adoc[Get started with Cypher] to learn how to write your own queries.
