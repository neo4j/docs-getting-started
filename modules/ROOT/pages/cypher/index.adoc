...
Available as open source via link:http://openCypher.org[The openCypher project], Cypher is similar to SQL, but optimized for graphs.
...
In the same way as xref:cypher/index.adoc#_node_variables [node variables], relationship variables can also be used as a shortcut.
...
In the complete Cypher documentation, you can learn more how to write link:{docs-home}/cypher-manual/current/queries/basic/[basic queries] and what link:{docs-home}/cypher-manual/current/clauses/[clauses] you can use to read data from the database.

== Keep learning

The GraphAcademy course link:https://graphacademy.neo4j.com/courses/cypher-fundamentals/[Cypher Fundamentals] gives further information on how to get started with Cypher and writing queries.
