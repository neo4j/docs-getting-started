...
In the xref:cypher/results.adoc#_filter[_Filtering on patterns_] section of the *_Getting the correct results_* chapter, you learnt how to filter based on patterns.
