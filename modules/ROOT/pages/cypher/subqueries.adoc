...
* xref:data-import/csv-files.adoc[Working with CSV files]
* xref:data-import/csv-import.adoc#optimizing-load-csv[Tutorial: Import CSV data using `LOAD CSV`]
...
In the xref:cypher/results.adoc#filter-patterns[_Filtering on patterns_] section of the *_Getting the correct results_* chapter, you learnt how to filter based on patterns.
