...
You can find its image in the xref:cypher/results.adoc#filter-ranges[following chapter].
...
Let's use the same queries from our xref:cypher/results.adoc#cypher-intro-results-unwind[examples with `UNWIND`] and see how you can order the candidates.
