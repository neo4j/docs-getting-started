...
The node and relationship variables, which are discussed xref:cypher/patterns.adoc#cypher-intro-patterns-node-syntax[earlier], become important when using `RETURN`.
