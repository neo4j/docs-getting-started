...
To see which second-degree co-actors appear most often in Keanu's network, you can take the frequency of occurrences into account by counting the number of paths between Tom Hanks and each `2dCoActor` and ordering them by highest to lowest value:
