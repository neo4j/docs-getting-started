...
It was briefly mentioned xref::cypher/patterns-in-practice.adoc#cypher-intro-patterns-in-practice-completing-patterns/[earlier] that there are some ways in Cypher to avoid creating duplicate data.
