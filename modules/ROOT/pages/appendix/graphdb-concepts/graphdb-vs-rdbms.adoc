...
This ends up creating a considerable structural difference.

For example, if you want to know which departments Alice belongs too, this is how a relational and a graph databases structure the same data:
