...
a| link:https://demo.neo4jlabs.com:7473/browser/?dbms=neo4j://stackoverflow@demo.neo4jlabs.com&db=stackoverflow[`stackoverflow`]
...
Some example datasets can be retrieved directly from Aura and Neo4j Browser in the form of guides.
With them, you can create or import a dataset and learn how to explore it.

=== Aura Learning Center

You can access the example datasets through the Learning Center in the link:{docs-home}/aura[Aura dashboard].
Select the cap icon image:icon-guides.svg[width=3%] in the left vertical menu to see a list of datasets available as learning guides.
