...
Some of them are built-in, others can be retrieved from a GitHub repository or accessed from the link:https://demo.neo4jlabs.com:7473[demo server] (choose "No authentication" as the authentication type).
