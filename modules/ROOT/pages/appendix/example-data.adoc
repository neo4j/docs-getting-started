...
When creating a new database in Neo4j AuraDB, besides the default empty you can also select one with the built-in Movie Graph and explore it following the Browser guide instructions.
