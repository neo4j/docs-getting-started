...
[NOTE]
To know more what are the differences between the two query languages, refer to the link:{docs-home}/cypher-manual/current/introduction/cypher-overview/#_cypher_and_sql_key_differences[Cypher documentation].
...
.. In case you are using Aura, click on the hat icon on the top-right side menu and follow the _Query fundamentals_ guide up to step 2.
+
...
A first, basic query that you can do is t
