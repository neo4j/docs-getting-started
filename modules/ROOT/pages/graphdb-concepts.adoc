...
For detailed descriptions of how to work with constraints in Cypher, see the xref:4.3@cypher-manual:ROOT:constraints/index.adoc#administration-constraints[Cypher manual -> Constraints].
