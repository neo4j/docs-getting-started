...
[TIP]
====
For a thorough description of the available data types, refer to the xref:4.2@cypher-manual:ROOT:syntax/values/index.adoc#cypher-values[Cypher manual -> Values and types].
====
...
For detailed descriptions of how to work with indexes in Cypher, see xref:4.2@cypher-manual:ROOT:administration/indexes-for-full-text-search/index.adoc#administration-indexes-fulltext-search[Cypher Manual -> Indexes].
...
For detailed descriptions of how to work with constraints in Cypher, see the xref:4.2@cypher-manual:ROOT:administration/constraints/index.adoc#administration-constraints[Cypher manual -> Constraints].
...
For the precise naming rules, refer to the xref:4.2@cypher-manual:ROOT:syntax/naming/index.adoc#cypher-naming[Cypher manual -> Naming rules and recommendations].
