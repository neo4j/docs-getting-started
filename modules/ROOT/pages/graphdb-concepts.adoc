...
For detailed descriptions of how to work with constraints in Cypher, see the xref:4.2@cypher-manual:ROOT:constraints/index.adoc[Cypher manual -> Constraints].
