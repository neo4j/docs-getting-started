...
[TIP]
====
For a thorough description of the available data types, refer to the link:{neo4j-docs-base-uri}/cypher-manual/4.2/syntax/values#cypher-values[Cypher manual -> Values and types].
====
...
For detailed descriptions of how to work with indexes in Cypher, see link:{neo4j-docs-base-uri}/cypher-manual/4.2/administration/indexes-for-full-text-search#administration-indexes-fulltext-search[Cypher Manual -> Indexes].
...
For detailed descriptions of how to work with constraints in Cypher, see the link:{neo4j-docs-base-uri}/cypher-manual/4.2/administration/constraints#administration-constraints[Cypher manual -> Constraints].
...
For the precise naming rules, refer to the link:{neo4j-docs-base-uri}/cypher-manual/4.2/syntax/naming#cypher-naming[Cypher manual -> Naming rules and recommendations].
