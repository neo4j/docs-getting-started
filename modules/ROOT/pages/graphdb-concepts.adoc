...
[TIP]
====
For a thorough description of the available data types, refer to the link:/cypher-manual/{page-version}/syntax/values#cypher-values[Cypher manual -> Values and types].
====
...
For detailed descriptions of how to work with indexes in Cypher, see link:/cypher-manual/{page-version}/indexes-for-full-text-search#administration-indexes-fulltext-search[Cypher Manual -> Indexes].
...
For detailed descriptions of how to work with constraints in Cypher, see the link:/cypher-manual/{page-version}/constraints[Cypher manual -> Constraints].
...
For the precise naming rules, refer to the link:/cypher-manual/{page-version}/syntax/naming#cypher-naming[Cypher manual -> Naming rules and recommendations].
