...
[TIP]
====
For a thorough description of the available data types, refer to the xref:4.3@cypher-manual:ROOT:syntax/values/index.adoc#cypher-values[Cypher manual -> Values and types].
====
