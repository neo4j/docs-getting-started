...
It is one of our link:https://neo4j.com/labs/[Neo4j Labs projects]. +
You can install it from the link:https://install.graphapp.io/[Graph App Gallery^].

==== NeoDash Resources

* Blog post: link:https://neo4j.com/developer-blog/neodash-2-0-a-brand-new-way-to-visualize-neo4j/[NeoDash 2.0 – A Brand New Way to Visualize Neo4j^]
* Documentation: link:https://github.com/neo4j-labs/neodash/wiki/User-Guide/[User Guide]
