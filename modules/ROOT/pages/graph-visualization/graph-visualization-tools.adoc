...
As more intelligence sources are integrated, specialized graphs can be created to support different types of analysis. Analysts can leverage graph data science to understand node importance within networks, predict links, and set up automated graph-based alerts. 
...
* Product: https://graphaware.com/hume/[GraphAware Hume]
* Features:
** https://graphaware.com/hume/streamlined-intelligence-analysis/[Intelligence Analysis]
** https://graphaware.com/hume/a-single-view-of-truth/[Data Ingestion]
** https://graphaware.com/hume/advanced-analysis-capabilities/[Advanced Intelligence Analysis]
** https://graphaware.com/hume/collaborative-decision-making/[Intelligence Sharing]
