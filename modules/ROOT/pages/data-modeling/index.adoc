...
include::https://raw.githubusercontent.com/neo4j-graphacademy/courses/main/asciidoc/courses/modeling-fundamentals/ad.adoc[]
...
xref:tutorials/relational-to-graph-modeling.adoc[Modeling: relational to graph]
