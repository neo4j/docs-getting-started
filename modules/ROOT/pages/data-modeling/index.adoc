...
* Have data on the products sold, the customers, and what they purchased at a certain point in time.
This process is known as "entity extraction".
* Understand how these entities relate to each other.
* Think about what other details need to be provided, i.e. what properties should be added to these entities (e.g. time of purchase, customer name).
...
Then, you can test this model by querying the database with a question (e.g. what did John buy):
