...
[source,cypher]
--
CREATE (m:Movie {title: 'Apollo 13', tmdbID: 568, released: '1995-06-30', imdbRating: 7.6, genres: ['Drama', 'Adventure', 'IMAX']})
CREATE (p:Person {name: 'Tom Hanks', tmdbID: 31, born: '1956-07-09'})
CREATE (p:Person {name: 'Meg Ryan', tmdbID: 5344, born: '1961-11-19'})
CREATE (p:Person {name: 'Danny DeVito', tmdbID: 518, born: '1944-11-17'})
CREATE (p:Person {name: 'Jack Nicholson', tmdbID: 514, born: '1937-04-22'})
CREATE (m:Movie {title: 'Sleepless in Seattle', tmdbID: 858, released: '1993-06-25', imdbRating: 6.8, genres: ['Comedy', 'Drama', 'Romance']})
CREATE (m:Movie {title: 'Hoffa', tmdbID: 10410, released: '1992-12-25', imdbRating: 6.6, genres: ['Crime', 'Drama']})
--
...
[source,cypher]
--
MERGE (TomH:Person {name:'Tom Hanks'})
MERGE (MegR:Person {name:'Meg Ryan'})
MERGE (DannyD:Person {name:'Danny DeVitto'})
MERGE (JackN:Person {name:'Jack Nicholson'})
