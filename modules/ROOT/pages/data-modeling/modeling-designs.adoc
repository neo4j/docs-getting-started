...
It is good and common practice to use verbs as relationship types, however, with linked lists, it is acceptable to connect sequential items using terms such as "next" and "previous" instead.
...
This timeline tree structure shows how you can quickly answer otherwise expensive questions.
