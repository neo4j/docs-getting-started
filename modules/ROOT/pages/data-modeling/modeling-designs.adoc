...
image::modeling_genre_property.jpg[role="popup-link"]
...
image::modeling_genre_node.jpg[role="popup-link"]
...
image:modeling_marvel_hyperedge_appearance.jpg[role="popup-link"]
...
image::modeling_airport_flights.jpg[role="popup-link"]
...
image::modeling_airport_flight_dates.jpg[role="popup-link"]
