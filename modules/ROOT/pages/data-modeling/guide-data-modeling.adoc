...
Most standard data types are supported as properties, and you can find information on that in the section https://neo4j.com/docs/getting-started/current/graphdb-concepts/#graphdb-properties[_Graph database concepts_^].
