...
image::matrix_whiteboard_model2.png[600,600,role="popup-link"]
...
image::property_graph_elements-arr.svg[role="popup-link"]
...
.Graph model - Nodes
image::modeling_johnsally_nodes-arr.svg[500,500,role="popup-link"]
...
.Graph model - Labels
image::modeling_johnsally_labels-arr.svg[500,500,role="popup-link"]
...
image::modeling_johnsally_relationships-arr.svg[500,500,role="popup-link"]
