...
Most standard data types are supported as properties, and you can find information on that in the section xref:appendix/graphdb-concepts/index.adoc[_Graph database concepts_^].
