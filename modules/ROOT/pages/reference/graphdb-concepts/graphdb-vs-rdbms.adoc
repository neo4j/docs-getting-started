...
[TIP]
====
You can find more about Cypher syntax in the upcoming chapters for xref:cypher.adoc[Cypher Query Language^] and transitioning xref:tutorials/cypher-sql.adoc[from SQL to Cypher^].
====
