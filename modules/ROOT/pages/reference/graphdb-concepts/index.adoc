...
To see examples of how to work with indexes, see link:{docs-home}/cypher-manual/current/indexes/[Using indexes].
...
To see examples of how to work with constraints, see link:/cypher-manual/current/constraints/[Using constraints].
