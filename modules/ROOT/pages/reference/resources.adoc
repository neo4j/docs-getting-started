...
To help you along your learning path about Neo4j, the following are some resources that may encourage you to dive deeper into Neo4j products and graph technology.
...
* https://graphacademy.neo4j.com/courses/cypher-fundamentals/[GraphAcademy: Cypher Fundamentals]
* https://community.neo4j.com/c/neo4j-graph-platform/cypher[Neo4j Community forum]
* https://neo4j.com/product/cypher-graph-query-language/[Cypher Query Language^]
* xref:tutorials/cypher-sql/[From SQL to Cypher]
