...
CSV data can be imported using either xref:how-to/csv-import.adoc#import-load-csv/[`LOAD CSV` clause in Cypher] or https://neo4j.com/docs/operations-manual/current/tutorial/neo4j-admin-import/[`neo4j-admin database import` for initial bulk imports^] of large datasets.
