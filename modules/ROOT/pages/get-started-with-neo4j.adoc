...
* link:{neo4j-docs-base-uri}/cypher-manual/4.2[The Cypher manual] -- This is the comprehensive manual for Cypher.
* link:{neo4j-docs-base-uri}/operations-manual/4.2[The Operations manual] -- This manual describes how to deploy and maintain Neo4j.
