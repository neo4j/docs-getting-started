...
* link:{neo4j-docs-base-uri}/cypher-manual/{page-version}[The Cypher manual] -- This is the comprehensive manual for Cypher.
* link:{neo4j-docs-base-uri}/operations-manual/{page-version}[The Operations manual] -- This manual describes how to deploy and maintain Neo4j.

The link:{neo4j-docs-base-uri}/cypher-refcard/current[Cypher Refcard] is a valuable asset when learning and writing Cypher.
