...
With a native graph database at the core, Neo4j offers link:https://neo4j.com/product/graph-data-science/[*Neo4j Graph Data Science*] -- a graph algorithms library for analysts and data scientists.
...
For more information about Cypher, visit link:https://neo4j.com/docs/cypher-manual/current/introduction/[Cypher Manual].
...
. Keep in mind compatibility requirements between the Python client, the Neo4j Python Driver, a server-side installation of the GDS library. Check them in the link:https://neo4j.com/docs/graph-data-science-client/current/installation/#python-client-system-requirements[GDS Client Manual].
...
We aim to create documentation that provides a direct practical experience for the users.
Therefore, our manuals contain instructions on how to apply graph algorithms from GDS to real-life use cases. 
