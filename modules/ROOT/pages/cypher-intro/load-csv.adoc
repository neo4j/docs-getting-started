...
[NOTE]
====
* For a full description of `LOAD CSV` , see link:{neo4j-docs-base-uri}/cypher-manual/4.1/clauses/load-csv/#query-load-csv[Cypher Manual -> `LOAD CSV`].
* For a full list of Cypher clauses, see link:{neo4j-docs-base-uri}/cypher-manual/4.1/clauses/#query-clause[Cypher Manual -> Clauses].
====
...
[NOTE]
====
* For the default directory of other installations see, link:{neo4j-docs-base-uri}/operations-manual/4.1/configuration/file-locations/#file-locations[Operations Manual -> File locations].
* The import location can be configured with link:{neo4j-docs-base-uri}/operations-manual/4.1/reference/configuration-settings/#config_dbms.directories.import[Operations Manual -> `dbms.directories.import`].
====
...
Or using link:{neo4j-docs-base-uri}/operations-manual/4.1/tools/cypher-shell/#cypher-shell[_Neo4j Cypher Shell_], run the command:
...
[TIP]
====
`LOAD CSV` also supports accessing CSV files via `HTTPS`, `HTTP`, and `FTP`, see link:{neo4j-docs-base-uri}/cypher-manual/4.1/clauses/load-csv/#query-load-csv[Cypher Manual -> `LOAD CSV`].
====
...
For more information, see link:{neo4j-docs-base-uri}/cypher-manual/4.1/query-tuning/using/#query-using-periodic-commit-hint[].
====
