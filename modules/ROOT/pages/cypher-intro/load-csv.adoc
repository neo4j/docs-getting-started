...
[NOTE]
====
* For a full description of `LOAD CSV` , see link:/cypher-manual/{page-version}/clauses/load-csv#query-load-csv[Cypher Manual -> `LOAD CSV`].
* For a full list of Cypher clauses, see link:/cypher-manual/{page-version}/clauses#query-clause[Cypher Manual -> Clauses].
====
...
[NOTE]
====
* For the default directory of other installations see, link:/operations-manual/{page-version}/configuration/file-locations#file-locations[Operations Manual -> File locations].
* The import location can be configured with link:/operations-manual/{page-version}/reference/configuration-settings#config_dbms.directories.import[Operations Manual -> `dbms.directories.import`].
====
...
Or using link:/operations-manual/{page-version}/tools/cypher-shell#cypher-shell[_Neo4j Cypher Shell_], run the command:
...
[TIP]
====
`LOAD CSV` also supports accessing CSV files via `HTTPS`, `HTTP`, and `FTP`, see link:/cypher-manual/{page-version}/clauses/load-csv#query-load-csv[Cypher Manual -> `LOAD CSV`].
====
...
For more information, see link:/cypher-manual/{page-version}/query-tuning/using#query-using-periodic-commit-hint[].
====
