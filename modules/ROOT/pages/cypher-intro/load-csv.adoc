...
[NOTE]
====
* For a full description of `LOAD CSV` , see xref:4.3@cypher-manual:ROOT:clauses/load-csv/index.adoc#query-load-csv[Cypher Manual -> `LOAD CSV`].
* For a full list of Cypher clauses, see xref:4.3@cypher-manual:ROOT:clauses/index.adoc#query-clause[Cypher Manual -> Clauses].
====
...
[NOTE]
====
* For the default directory of other installations see, xref:4.3@operations-manual:ROOT:configuration/file-locations/index.adoc#file-locations[Operations Manual -> File locations].
* The import location can be configured with xref:4.3@operations-manual:ROOT:reference/configuration-settings/index.adoc#config_dbms.directories.import[Operations Manual -> `dbms.directories.import`].
====
...
Or using xref:4.3@operations-manual:ROOT:tools/cypher-shell/index.adoc#cypher-shell[_Neo4j Cypher Shell_], run the command:
...
[TIP]
====
`LOAD CSV` also supports accessing CSV files via `HTTPS`, `HTTP`, and `FTP`, see xref:4.3@cypher-manual:ROOT:clauses/load-csv/index.adoc#query-load-csv[Cypher Manual -> `LOAD CSV`].
====
...
For more information, see xref:4.3@cypher-manual:ROOT:query-tuning/using/index.adoc#query-using-periodic-commit-hint[].
====
