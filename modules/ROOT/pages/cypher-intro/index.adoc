...
** xref::/cypher-intro/schema.adoc#cypher-intro-schema-indexes[Using indexes]
** xref::/cypher-intro/schema.adoc#cypher-intro-schema-constraints[Using constraints]
