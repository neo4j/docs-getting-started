...
[TIP]
====
For the full reference of Cypher, see the xref:4.4@cypher-manual:ROOT:index.adoc#cypher-manual[Cypher documentation].
====
...
Getting Started manual covers the basics of the language, which you can explore by topic area below, starting with basic material, and building up towards more complex material.
...
:description: This guide explains the basic concepts of Cypher, Neo4j's graph query language.
...
The concepts in the video are discussed in the paragraphs below, as well as in upcoming chapters.
...
As you work through this section, you will see comments in the Cypher code to help explain the syntax or what a query is doing.
