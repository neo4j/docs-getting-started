...
To write this type of existence check, you need to use the `WHERE` clause and the `exists()` method for that property.
>>>>>>> 6ead7c8 (Update Getting the correct results and other images (#124))
