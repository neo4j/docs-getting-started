...
a|  If you want to see **who** (e.g. the company Drachenblut Delikatessen) bought **what** and what they **paid in total**, in SQL, you have to use `INNER JOINS` to make sure that results are returned even if there are no matching rows in other tables:
