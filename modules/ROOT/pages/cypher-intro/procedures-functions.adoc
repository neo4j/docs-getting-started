...
That's why Neo4j and Cypher can be extended with _User defined procedures and functions_.
...
Also take a look at the link:https://neo4j.com/docs/java-reference/current/extending-neo4j/[procedure section in the Neo4j Manual^].
