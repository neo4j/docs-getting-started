...
* xref::/cypher-intro/schema.adoc#cypher-intro-schema-indexes[Defining and using indexes]
* xref::/cypher-intro/schema.adoc#cypher-intro-schema-constraints[Defining and using constraints]
