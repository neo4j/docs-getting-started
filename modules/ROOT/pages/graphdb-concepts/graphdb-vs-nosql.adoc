...
:description: This chapter explains how graph databases are related to other NoSQL databases and how they differ.
:page-pagination:
:page-aliases: ROOT:appendix/graphdb-concepts/graphdb-vs-nosql.adoc
...
ifdef::backend-pdf[]
link:https://www.youtube.com/embed/5Tl8WcaqZoc[Video: Evolution of DBs]
endif::[]
...
image::database_compare.jpg[500,500,role="popup-link"]
...
image::key_value_model.jpg[500,500,role="popup-link"]
...
image::key_value_as_graph.jpg[500,500,role="popup-link"]
...
image::document_model.jpg[500,500,role="popup-link"]
...
image::document_as_graph.jpg[500,500,role="popup-link"]
