...
Neo4j stores nodes and relationships instead of tables or documents.
...
This stability and maturity is why it's been used in production scenarios for large enterprise workloads for years.
