...
2. https://github.com/cheerfulstoic[Brian Underwood^] and https://github.com/subvertallchris[Chris Grigg^] joined the project and together released https://neo4j.com/blog/neo4j-rb-3-0-released/[version 3.0^] in September 2014.
