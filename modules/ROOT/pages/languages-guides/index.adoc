...
If you want to access Neo4j programmatically, you can also use the https://neo4j.com/docs/http-api/current/actions/[HTTP-API^] which allow you to:
...
[source, json]
----
:POST /db/<database-name>/txt/commit {"statements":[
