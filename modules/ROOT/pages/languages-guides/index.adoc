...
If you are new to development, we recommend the https://www.jetbrains.com/products.html[Jetbrains IDE^] for a good developer experience which also comes with a link:https://neo4j.com/blog/jetbrains-ide-plugin-graph-database/[Neo4j Database plugin^].
...
If you want to access Neo4j programmatically, you can also use the HTTP API which allows you to:
